...
<body style="background-color: #ECF0F1;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand mx-auto" href="#" style="font-family: Arial, sans-serif; font-size: 42px;"><strong>Department</strong></a>
        </div>
    </nav>
    <div id="main-content" class="container mt-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-end align-items-center w-100">
                <button class="btn btn-primary custom-button me-3" data-bs-toggle="modal" data-bs-target="#addDepartmentModal">Add Department</button>
                <button class="btn btn-primary custom-button" data-bs-toggle="modal" data-bs-target="#addTransactionModal">Add Transaction</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addDepartmentModal" tabindex="-1" aria-labelledby="addDepartmentModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addDepartmentForm">
                        @csrf
                        <div class="mb-3">
                            <label for="departmentName" class="form-label" style="font-weight: bold;">Department Name</label>
...
<div class="modal fade" id="viewTransactionsModal" tabindex="-1" aria-labelledby="viewTransactionsModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                ...
                <div class="modal-body">
                    <form id="addTransactionForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="transactionInput" placeholder="Enter Transaction Type" required>
                        </div>
                        <div class="mb-3">
...
<div class="modal fade" id="editTransactionModal" tabindex="-1" role="dialog" aria-labelledby="editTransactionModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="editTransactionModalLabel" style="color: white;">Edit Transaction</h5>
            ...
            <div class="modal-body">
                ...
                <form id="editTransactionForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="editTransactionType" placeholder="Enter transaction type">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
            ...
            <div class="modal-body">
                <form id="editDepartmentForm">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="saveEditDepartment">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
...
$(document).on('click', '.edit-department-btn', function () {
    ...
    var departmentName = $(this).closest('tr').find('td:first').text(); // Get the department name from the table cell
