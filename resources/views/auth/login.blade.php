                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="department" class="form-select @error('department') is-invalid @enderror"
                                    ...
                                    <option value="Registrar" {{ old('department') == 'Registrar' ? 'selected' : '' }}>
                                        Registrar</option>
                                    <option value="Admin" {{ old('department') == 'Admin' ? 'selected' : '' }}>Admin
                                    </option>
                                    <option value="Cashier" {{ old('department') == 'Cashier' ? 'selected' : '' }}>Cashier
                                    </option>
                                </select>
                                @error('department')
                                    <span class="invalid-feedback" role="alert">
