...
<head>
    ...
    <style>
        ...
        .form-container {
            ...
            background: white;
            overflow-y: auto;
            /* Enable vertical scrollbar if content exceeds container height */
        }
        ...
        .modal-footer {
            ...
            /* Align buttons to the end of the footer */
        }
                    ...
                    $.ajax({
                                ...
                                response.departments.forEach(function(department) {
                                    ...
                                    departmentButton.click(function() {
                                        selectedDepartment = department
                                            .name; // Update selected department
                                        $('#departmentModalLabel').text(department.name);
                                        $('#departmentDetails').text('Details for ' +
                                            department.name);
                        ...
                        error: function(xhr, status, error) {
                            ...
                            $('#departmentList').append(
                                '<li class="text-danger">Error fetching departments. Please try again later.</li>'
                            );
                        }
                    });
                }
                                ...
                                if (matchedStudents.length > 0) {
                                    matchedStudents.forEach(function(student) {
                                        ...
                                        formattedData.click(function() {
                                            ...
                                            var nameInfo = $('<p>').text('Name: ' +
                                                selectedName);
                                            var gradeInfo = $('<p>').text('Grade: ' +
                                                selectedGrade);
                                            var sectionInfo = $('<p>').text('Section: ' +
                                                selectedSection);
                                            $('#formTextContainer').append(nameInfo,
                                                gradeInfo, sectionInfo);

                                            appendDoneButton
                                                (); // Add a "Done" button after clicking on a student's name
                                        });

                                        $('#formTextContainer').append(formattedData);
                                    });
                                } else {
                                    $('#formTextContainer').text('No students found matching "' +
                                        enteredName + '"');
                                }
                            } else {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                `;
                        ...
                        saveButton.addEventListener('click', function() {
                            const inputTransaction = document.getElementById('inputTransaction')
                                .value;
